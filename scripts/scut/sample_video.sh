...
export TRAIN_STEPS="36200"
export CKPT_PATH="/public/home/201810101923/code/PKU-Open-Sora-Forked/out_webvidlatent_${TRAIN_SIZE}_qknorm_rope/checkpoint-${TRAIN_STEPS}/model/diffusion_pytorch_model.safetensors"
