...
srun --jobid $SLURM_JOBID bash -c 'accelerate launch \
  ...
  --model_path /public/home/201810101923/code/PKU-Open-Sora-Forked/t2v-f65-512-img16-videovae488-bf16-ckpt-xformers-bs4-lr2e-5-t5/checkpoint-4500/model/diffusion_pytorch_model.safetensors  \
