...
export OUTPUT_DIR="./sample_videos/demo_17x256x256_steps20000"
srun --jobid $SLURM_JOBID bash -c 'accelerate launch \
  ...
  --ckpt_path /public/home/201810101923/code/PKU-Open-Sora-Forked/out_internvid_17x256x256/checkpoint-20000/model/diffusion_pytorch_model.safetensors  \
